...
class HSVContourMapper:
    ...
    def generate_contour_map(self, output_file: Path, dimension='V', num_levels=10):
        """
        Convenience method that performs the full pipeline: create height matrix,
        compute contours, and export as SVG.
        ...
        logger.info(f"Contour map generated using HSV {dimension} dimension with {num_levels} levels.")
